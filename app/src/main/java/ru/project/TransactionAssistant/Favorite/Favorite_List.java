...
public class Favorite_List extends AppCompatActivity {
    ...
    public void onUpdateFavorite_Adapter() {
        ...
        if(cursor_dataDB_transfer.getCount() == 0 & cursor_dataDB_phone.getCount() == 0 & cursor_dataDB_balance.getCount() == 0 & cursor_dataDB_history.getCount() == 0 & cursor_dataDB_thank.getCount() == 0) {
            ...
            int int_columnID_transfer_main = cursor_dataDB_transfer.getColumnIndex(InputContract.TableEntry.COL_TRANSFER_main);
            ...
            int int_columnID_phone_main = cursor_dataDB_phone.getColumnIndex(InputContract.TableEntry.COL_PHONE_main);
            ...
            int int_columnID_balance_main = cursor_dataDB_balance.getColumnIndex(InputContract.TableEntry.COL_BALANCE_main);
            ...
            int int_columnID_history_main = cursor_dataDB_history.getColumnIndex(InputContract.TableEntry.COL_HISTORY_main);
            ...
            int int_columnID_thank_main = cursor_dataDB_thank.getColumnIndex(InputContract.TableEntry.COL_THANK_main);
